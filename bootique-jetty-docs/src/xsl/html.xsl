...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="head.content">
        ...
        <meta name="keywords" content="Bootique Jetty Documentation version ${bootique.version.major} "/>
        <meta name="description" content="Bootique Jetty: integration of Jetty web container with Bootique framework - Documentation version ${bootique.version.major}"/>
